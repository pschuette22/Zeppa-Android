...
public class CloudEndpointUtils {
	 ...
	 * information.
	 */
	protected static final boolean LOCAL_ANDROID_RUN = !Constants.IS_CONNECTED;
	...
	private final static String APPENGINE_APP_NAME = "Zeppa";
	...
	public static <B extends AbstractGoogleClient.Builder> B updateBuilder(
		...
		builder.setApplicationName(APPENGINE_APP_NAME);
