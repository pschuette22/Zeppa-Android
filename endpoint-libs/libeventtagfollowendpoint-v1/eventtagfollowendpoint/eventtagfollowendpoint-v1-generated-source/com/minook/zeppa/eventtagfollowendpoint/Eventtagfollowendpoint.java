...
public class Eventtagfollowendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class EventTagFollowEndpoint {
    ...
    /**
     * Create a request for the method "eventTagFollowEndpoint.getUsersFollowingEvent".
     *
     * This request holds the parameters needed by the eventtagfollowendpoint server.  After setting any
     * optional parameters, call the {@link GetUsersFollowingEvent#execute()} method to invoke the
     * remote operation.
     *
     * @param tagId
     * @return the request
     */
    public GetUsersFollowingEvent getUsersFollowingEvent(java.lang.Long tagId) throws java.io.IOException {
      GetUsersFollowingEvent result = new GetUsersFollowingEvent(tagId);
      initialize(result);
      return result;
    }

    public class GetUsersFollowingEvent extends EventtagfollowendpointRequest<com.minook.zeppa.eventtagfollowendpoint.model.StringCollection> {

      private static final String REST_PATH = "longcollection/{tagId}";

      /**
       * Create a request for the method "eventTagFollowEndpoint.getUsersFollowingEvent".
       *
       * This request holds the parameters needed by the the eventtagfollowendpoint server.  After
       * setting any optional parameters, call the {@link GetUsersFollowingEvent#execute()} method to
       * invoke the remote operation. <p> {@link GetUsersFollowingEvent#initialize(com.google.api.client
       ...
       * @since 1.13
       */
      protected GetUsersFollowingEvent(java.lang.Long tagId) {
        super(Eventtagfollowendpoint.this, "GET", REST_PATH, null, com.minook.zeppa.eventtagfollowendpoint.model.StringCollection.class);
      ...
      @Override
      public GetUsersFollowingEvent setAlt(java.lang.String alt) {
        return (GetUsersFollowingEvent) super.setAlt(alt);
      }

      @Override
      public GetUsersFollowingEvent setFields(java.lang.String fields) {
        return (GetUsersFollowingEvent) super.setFields(fields);
      }

      @Override
      public GetUsersFollowingEvent setKey(java.lang.String key) {
        return (GetUsersFollowingEvent) super.setKey(key);
      }

      @Override
      public GetUsersFollowingEvent setOauthToken(java.lang.String oauthToken) {
        return (GetUsersFollowingEvent) super.setOauthToken(oauthToken);
      }

      @Override
      public GetUsersFollowingEvent setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (GetUsersFollowingEvent) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public GetUsersFollowingEvent setQuotaUser(java.lang.String quotaUser) {
        return (GetUsersFollowingEvent) super.setQuotaUser(quotaUser);
      }

      @Override
      public GetUsersFollowingEvent setUserIp(java.lang.String userIp) {
        return (GetUsersFollowingEvent) super.setUserIp(userIp);
      }
      ...
      public GetUsersFollowingEvent setTagId(java.lang.Long tagId) {
        this.tagId = tagId;
        return this;
      }

      @Override
      public GetUsersFollowingEvent set(String parameterName, Object value) {
        return (GetUsersFollowingEvent) super.set(parameterName, value);
      }
    }
