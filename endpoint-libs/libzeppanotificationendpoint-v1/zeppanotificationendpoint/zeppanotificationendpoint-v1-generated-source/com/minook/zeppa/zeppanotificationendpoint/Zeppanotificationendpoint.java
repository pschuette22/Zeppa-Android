...
public class Zeppanotificationendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the zeppanotificationendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  /**
   * An accessor for creating requests from the ZeppaNotificationEndpoint collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Zeppanotificationendpoint zeppanotificationendpoint = new Zeppanotificationendpoint(...);}
   *   {@code Zeppanotificationendpoint.ZeppaNotificationEndpoint.List request = zeppanotificationendpoint.zeppaNotificationEndpoint().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public ZeppaNotificationEndpoint zeppaNotificationEndpoint() {
    return new ZeppaNotificationEndpoint();
  }

  /**
   * The "zeppaNotificationEndpoint" collection of methods.
   */
  public class ZeppaNotificationEndpoint {

    /**
     * Create a request for the method "zeppaNotificationEndpoint.sendNotificationPingToUser".
     *
     * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
     * setting any optional parameters, call the {@link SendNotificationPingToUser#execute()} method to
     * invoke the remote operation.
     *
     * @param content the {@link com.minook.zeppa.zeppanotificationendpoint.model.ZeppaNotification}
     * @return the request
     */
    public SendNotificationPingToUser sendNotificationPingToUser(com.minook.zeppa.zeppanotificationendpoint.model.ZeppaNotification content) throws java.io.IOException {
      SendNotificationPingToUser result = new SendNotificationPingToUser(content);
      initialize(result);
      return result;
    }

    public class SendNotificationPingToUser extends ZeppanotificationendpointRequest<Void> {

      private static final String REST_PATH = "sendNotificationPingToUser";

      /**
       * Create a request for the method "zeppaNotificationEndpoint.sendNotificationPingToUser".
       *
       * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
       * setting any optional parameters, call the {@link SendNotificationPingToUser#execute()} method
       * to invoke the remote operation. <p> {@link SendNotificationPingToUser#initialize(com.google.api
       ...
       * @since 1.13
       */
      protected SendNotificationPingToUser(com.minook.zeppa.zeppanotificationendpoint.model.ZeppaNotification content) {
        super(Zeppanotificationendpoint.this, "POST", REST_PATH, content, Void.class);
      }

      @Override
      public SendNotificationPingToUser setAlt(java.lang.String alt) {
        return (SendNotificationPingToUser) super.setAlt(alt);
      }

      @Override
      public SendNotificationPingToUser setFields(java.lang.String fields) {
        return (SendNotificationPingToUser) super.setFields(fields);
      }

      @Override
      public SendNotificationPingToUser setKey(java.lang.String key) {
        return (SendNotificationPingToUser) super.setKey(key);
      }

      @Override
      public SendNotificationPingToUser setOauthToken(java.lang.String oauthToken) {
        return (SendNotificationPingToUser) super.setOauthToken(oauthToken);
      }

      @Override
      public SendNotificationPingToUser setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SendNotificationPingToUser) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SendNotificationPingToUser setQuotaUser(java.lang.String quotaUser) {
        return (SendNotificationPingToUser) super.setQuotaUser(quotaUser);
      }

      @Override
      public SendNotificationPingToUser setUserIp(java.lang.String userIp) {
        return (SendNotificationPingToUser) super.setUserIp(userIp);
      }

      @Override
      public SendNotificationPingToUser set(String parameterName, Object value) {
        return (SendNotificationPingToUser) super.set(parameterName, value);
      }
    }
    /**
     * Create a request for the method "zeppaNotificationEndpoint.sendNotificationPingToUsers".
     *
     * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
     * setting any optional parameters, call the {@link SendNotificationPingToUsers#execute()} method to
     * invoke the remote operation.
     *
     * @param userIds
     * @param content the {@link com.minook.zeppa.zeppanotificationendpoint.model.ZeppaNotification}
     * @return the request
     */
    public SendNotificationPingToUsers sendNotificationPingToUsers(java.util.List<java.lang.Long> userIds, com.minook.zeppa.zeppanotificationendpoint.model.ZeppaNotification content) throws java.io.IOException {
      SendNotificationPingToUsers result = new SendNotificationPingToUsers(userIds, content);
      initialize(result);
      return result;
    }

    public class SendNotificationPingToUsers extends ZeppanotificationendpointRequest<Void> {

      private static final String REST_PATH = "sendNotificationPingToUsers/{userIds}";

      /**
       * Create a request for the method "zeppaNotificationEndpoint.sendNotificationPingToUsers".
       *
       * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
       * setting any optional parameters, call the {@link SendNotificationPingToUsers#execute()} method
       * to invoke the remote operation. <p> {@link SendNotificationPingToUsers#initialize(com.google.ap
       ...
       * @since 1.13
       */
      protected SendNotificationPingToUsers(java.util.List<java.lang.Long> userIds, com.minook.zeppa.zeppanotificationendpoint.model.ZeppaNotification content) {
        super(Zeppanotificationendpoint.this, "POST", REST_PATH, content, Void.class);
        this.userIds = com.google.api.client.util.Preconditions.checkNotNull(userIds, "Required parameter userIds must be specified.");
      }

      @Override
      public SendNotificationPingToUsers setAlt(java.lang.String alt) {
        return (SendNotificationPingToUsers) super.setAlt(alt);
      }

      @Override
      public SendNotificationPingToUsers setFields(java.lang.String fields) {
        return (SendNotificationPingToUsers) super.setFields(fields);
      }

      @Override
      public SendNotificationPingToUsers setKey(java.lang.String key) {
        return (SendNotificationPingToUsers) super.setKey(key);
      }

      @Override
      public SendNotificationPingToUsers setOauthToken(java.lang.String oauthToken) {
        return (SendNotificationPingToUsers) super.setOauthToken(oauthToken);
      }

      @Override
      public SendNotificationPingToUsers setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SendNotificationPingToUsers) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SendNotificationPingToUsers setQuotaUser(java.lang.String quotaUser) {
        return (SendNotificationPingToUsers) super.setQuotaUser(quotaUser);
      }

      @Override
      public SendNotificationPingToUsers setUserIp(java.lang.String userIp) {
        return (SendNotificationPingToUsers) super.setUserIp(userIp);
      }
      ...
      public SendNotificationPingToUsers setUserIds(java.util.List<java.lang.Long> userIds) {
        this.userIds = userIds;
        return this;
      }

      @Override
      public SendNotificationPingToUsers set(String parameterName, Object value) {
        return (SendNotificationPingToUsers) super.set(parameterName, value);
      }
    }
   ...
   *
   * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
   * setting any optional parameters, call the {@link GetNotificationList#execute()} method to invoke
  ...
  /**
   * Create a request for the method "getUserNotifications".
   *
   * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
   * setting any optional parameters, call the {@link GetUserNotifications#execute()} method to invoke
   * the remote operation.
   *
   * @param userId
   * @param cursorString
   ...
   * @return the request
   */
  public GetUserNotifications getUserNotifications(java.lang.Long userId, java.lang.String cursorString, java.lang.Integer limit) throws java.io.IOException {
    GetUserNotifications result = new GetUserNotifications(userId, cursorString, limit);
    initialize(result);
    return result;
  }

  public class GetUserNotifications extends ZeppanotificationendpointRequest<com.minook.zeppa.zeppanotificationendpoint.model.CollectionResponseZeppaNotification> {

    private static final String REST_PATH = "collectionresponse_zeppanotification/{userId}/{cursorString}/{limit}";

    /**
     * Create a request for the method "getUserNotifications".
     *
     * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
     * setting any optional parameters, call the {@link GetUserNotifications#execute()} method to
     * invoke the remote operation. <p> {@link GetUserNotifications#initialize(com.google.api.client.g
     ...
     * @since 1.13
     */
    protected GetUserNotifications(java.lang.Long userId, java.lang.String cursorString, java.lang.Integer limit) {
      super(Zeppanotificationendpoint.this, "GET", REST_PATH, null, com.minook.zeppa.zeppanotificationendpoint.model.CollectionResponseZeppaNotification.class);
      this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
    ...
    @Override
    public GetUserNotifications setAlt(java.lang.String alt) {
      return (GetUserNotifications) super.setAlt(alt);
    }

    @Override
    public GetUserNotifications setFields(java.lang.String fields) {
      return (GetUserNotifications) super.setFields(fields);
    }

    @Override
    public GetUserNotifications setKey(java.lang.String key) {
      return (GetUserNotifications) super.setKey(key);
    }

    @Override
    public GetUserNotifications setOauthToken(java.lang.String oauthToken) {
      return (GetUserNotifications) super.setOauthToken(oauthToken);
    }

    @Override
    public GetUserNotifications setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetUserNotifications) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetUserNotifications setQuotaUser(java.lang.String quotaUser) {
      return (GetUserNotifications) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetUserNotifications setUserIp(java.lang.String userIp) {
      return (GetUserNotifications) super.setUserIp(userIp);
    }
    ...
    public GetUserNotifications setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
    ...
    public GetUserNotifications setCursorString(java.lang.String cursorString) {
    ...
    public GetUserNotifications setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }

    @Override
    public GetUserNotifications set(String parameterName, Object value) {
      return (GetUserNotifications) super.set(parameterName, value);
    }
  }
   ...
   *
   * This request holds the parameters needed by the the zeppanotificationendpoint server.  After
   * setting any optional parameters, call the {@link GetZeppaNotification#execute()} method to invoke
   * the remote operation.
   *
   * @param id
   * @return the request
