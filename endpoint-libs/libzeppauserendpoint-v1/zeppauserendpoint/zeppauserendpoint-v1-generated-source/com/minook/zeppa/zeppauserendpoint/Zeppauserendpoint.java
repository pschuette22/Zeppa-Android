...
public class Zeppauserendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "fetchCurrentZeppaUser".
   *
   * This request holds the parameters needed by the zeppauserendpoint server.  After setting any
   * optional parameters, call the {@link FetchCurrentZeppaUser#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public FetchCurrentZeppaUser fetchCurrentZeppaUser() throws java.io.IOException {
    FetchCurrentZeppaUser result = new FetchCurrentZeppaUser();
    initialize(result);
    return result;
  }

  public class FetchCurrentZeppaUser extends ZeppauserendpointRequest<com.minook.zeppa.zeppauserendpoint.model.ZeppaUser> {

    private static final String REST_PATH = "fetchCurrentZeppaUser";

    /**
     * Create a request for the method "fetchCurrentZeppaUser".
     *
     * This request holds the parameters needed by the the zeppauserendpoint server.  After setting
     * any optional parameters, call the {@link FetchCurrentZeppaUser#execute()} method to invoke the
     * remote operation. <p> {@link FetchCurrentZeppaUser#initialize(com.google.api.client.googleapis.
     * services.AbstractGoogleClientRequest)} must be called to initialize this instance immediately
     * after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected FetchCurrentZeppaUser() {
      super(Zeppauserendpoint.this, "POST", REST_PATH, null, com.minook.zeppa.zeppauserendpoint.model.ZeppaUser.class);
    }

    @Override
    public FetchCurrentZeppaUser setAlt(java.lang.String alt) {
      return (FetchCurrentZeppaUser) super.setAlt(alt);
    }

    @Override
    public FetchCurrentZeppaUser setFields(java.lang.String fields) {
      return (FetchCurrentZeppaUser) super.setFields(fields);
    }

    @Override
    public FetchCurrentZeppaUser setKey(java.lang.String key) {
      return (FetchCurrentZeppaUser) super.setKey(key);
    }

    @Override
    public FetchCurrentZeppaUser setOauthToken(java.lang.String oauthToken) {
      return (FetchCurrentZeppaUser) super.setOauthToken(oauthToken);
    }

    @Override
    public FetchCurrentZeppaUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FetchCurrentZeppaUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FetchCurrentZeppaUser setQuotaUser(java.lang.String quotaUser) {
      return (FetchCurrentZeppaUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public FetchCurrentZeppaUser setUserIp(java.lang.String userIp) {
      return (FetchCurrentZeppaUser) super.setUserIp(userIp);
    }

    @Override
    public FetchCurrentZeppaUser set(String parameterName, Object value) {
      return (FetchCurrentZeppaUser) super.set(parameterName, value);
    }
  }
  ...
  public class ListZeppaUser extends ZeppauserendpointRequest<com.minook.zeppa.zeppauserendpoint.model.CollectionResponseZeppaUser> {
    ...
    public ListZeppaUser setFilter(java.lang.String filter) {
      this.filter = filter;
      return this;
    }
    ...
    public ListZeppaUser setOrdering(java.lang.String ordering) {
