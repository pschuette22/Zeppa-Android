 ...
 * on 2014-08-20 at 15:31:43 UTC 
 * Modify at your own risk.
 */

package com.minook.zeppa.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "fetchUserDevices".
   *
   * This request holds the parameters needed by the deviceinfoendpoint server.  After setting any
   * optional parameters, call the {@link FetchUserDevices#execute()} method to invoke the remote
   * operation.
   *
   * @param userId
   * @param startIndex
   * @return the request
   */
  public FetchUserDevices fetchUserDevices(java.lang.Long userId, java.lang.Integer startIndex) throws java.io.IOException {
    FetchUserDevices result = new FetchUserDevices(userId, startIndex);
    initialize(result);
    return result;
  }

  public class FetchUserDevices extends DeviceinfoendpointRequest<com.minook.zeppa.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {

    private static final String REST_PATH = "fetchUserDevices/{userId}/{startIndex}";

    /**
     * Create a request for the method "fetchUserDevices".
     *
     * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting
     * any optional parameters, call the {@link FetchUserDevices#execute()} method to invoke the
     * remote operation. <p> {@link FetchUserDevices#initialize(com.google.api.client.googleapis.servi
     ...
     * @since 1.13
     */
    protected FetchUserDevices(java.lang.Long userId, java.lang.Integer startIndex) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, null, com.minook.zeppa.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    ...
    @Override
    public FetchUserDevices setAlt(java.lang.String alt) {
      return (FetchUserDevices) super.setAlt(alt);
    }

    @Override
    public FetchUserDevices setFields(java.lang.String fields) {
      return (FetchUserDevices) super.setFields(fields);
    }

    @Override
    public FetchUserDevices setKey(java.lang.String key) {
      return (FetchUserDevices) super.setKey(key);
    }

    @Override
    public FetchUserDevices setOauthToken(java.lang.String oauthToken) {
      return (FetchUserDevices) super.setOauthToken(oauthToken);
    }

    @Override
    public FetchUserDevices setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FetchUserDevices) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FetchUserDevices setQuotaUser(java.lang.String quotaUser) {
      return (FetchUserDevices) super.setQuotaUser(quotaUser);
    }

    @Override
    public FetchUserDevices setUserIp(java.lang.String userIp) {
      return (FetchUserDevices) super.setUserIp(userIp);
    }
    ...
    public FetchUserDevices setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
    ...
    public FetchUserDevices setStartIndex(java.lang.Integer startIndex) {
      this.startIndex = startIndex;
      return this;
    }

    @Override
    public FetchUserDevices set(String parameterName, Object value) {
      return (FetchUserDevices) super.set(parameterName, value);
    }
  }
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(java.lang.Long id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.minook.zeppa.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.minook.zeppa.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo.class);
    }
