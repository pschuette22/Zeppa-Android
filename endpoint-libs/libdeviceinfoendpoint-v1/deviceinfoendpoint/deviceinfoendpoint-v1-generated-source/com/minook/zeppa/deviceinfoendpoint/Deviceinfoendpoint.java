...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.minook.zeppa.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    public ListDeviceInfo setFilter(java.lang.String filter) {
      this.filter = filter;
      return this;
    }
    ...
    public ListDeviceInfo setOrdering(java.lang.String ordering) {
   ...
   * @return the request
   */
  public RemoveDeviceInfo removeDeviceInfo(com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    RemoveDeviceInfo result = new RemoveDeviceInfo(content);
    initialize(result);
    return result;
  }
  ...
  public class RemoveDeviceInfo extends DeviceinfoendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveDeviceInfo(com.minook.zeppa.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "DELETE", REST_PATH, content, Void.class);
    }
